<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        @if(Auth::user()->isOwner() || Auth::user()->isAdmin())
                            <x-nav-link :href="route('owner.accommodations.index')" :active="request()->routeIs('owner.accommodations.*')">
                                {{ __('My Properties') }}
                            </x-nav-link>
                        @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                @if(Auth::user()->isOwner() || Auth::user()->isAdmin())
                    <x-responsive-nav-link :href="route('owner.accommodations.index')" :active="request()->routeIs('owner.accommodations.*')">
                        {{ __('My Properties') }}
                    </x-responsive-nav-link>
                @endif
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4 flex items-center gap-3">
                ...
                @else
                    <div class="w-10 h-10 rounded-full bg-green-600 flex items-center justify-center text-white text-sm font-bold">
                        {{ substr(Auth::user()->name, 0, 2) }}
                    </div>
                @endif
                <div>
